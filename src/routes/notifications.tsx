...
export const Route = createFileRoute("/notifications")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Every alert, agent action, and warning across your productions." },
    ],
  }),
});
...
function Notifications() {
  ...
  return (
    <>
      <PageHeader
        title="Notifications"
        subtitle="Real-time alerts from every agent. Prioritized by production impact."
        action={
        ...
        <div className="space-y-2">
          {notifications.map((n, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-lg ${colorFor[n.type]}`}
                >
